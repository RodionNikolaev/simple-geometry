...
export function earcut(data: number[], holeIndices: number[] = null, dim: number = 2): number[] {
...
function filterPoints(start: node, end = start): node {
...
function isValidDiagonal(a: node, b: node): boolean | number {
    return !!(
        a.next.i !== b.i &&
        a.prev.i !== b.i &&
